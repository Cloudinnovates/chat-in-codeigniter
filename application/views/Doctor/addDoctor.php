    ...
    <div class="limiter">
		<div class="container-login100 page-background">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo base_url(); ?>login/saveDoctor" enctype="multipart/form-data" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter Last Name">
						...
						<span class="focus" data-placeholder="&#xf207;"></span>
                                        ...
                                        <div class="col-lg-6 p-t-20">
					<div class="wrap-input100 validate-input" data-validate = "Enter Passing Year">
						<input class="input100" type="text" name="passYear" placeholder="Passing Year">
						<span class="focus" data-placeholder="&#xf207;"></span>
					</div>
					</div> 
                                      <div class="col-lg-6 p-t-20">
					<div class="wrap-input100 validate-input" data-validate = "Enter BMDC Registration No">
						<input class="input100" type="text" name="regNumber" placeholder="BMDC Registration No">
						<span class="focus" data-placeholder="&#xf207;"></span>
					</div>
					</div> 
					<div class="col-lg-6 p-t-20">
					<div class="wrap-input100 validate-input" data-validate = "Enter Extra Degree">
                                            <input class="input100" type="text" name="degree" placeholder="Degree/Specialize">
						<span class="focus" data-placeholder="&#xf207;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="chamAddress" placeholder="Chamber Address">
						<span class="focus" data-placeholder="&#xf207;"></span>
					</div>
					</div>
                                            <div class="col-lg-6 p-t-20">
