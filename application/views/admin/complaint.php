                                ...
                                <ul class="activity-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="activity-desk">
                                            <h5><a href="#"><?php echo $com->date?></a> <span style="float: right"><a href="<?php echo base_url();?>admin/deleteComplaint/<?php echo $com->complaint_id?>" class="btn btn-danger btn-xs">
