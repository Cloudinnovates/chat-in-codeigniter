                        ...
                        <!-- end message dropdown -->
 						...
 						<li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle " src="<?php echo base_url();?>img/dp.jpg" />
                    ...
                    <ul class="nav navbar-nav">
                        <li class="mega-menu-dropdown active open">
                         ...
                         <li class="classic-menu-dropdown mega-menu-dropdown">
                                <a href="#" class=" megamenu-dropdown" data-close-others="true"> <i class="fa fa-user-md"></i>  Doctors
                                <i class="fa fa-angle-down"></i>
                            ...
                            <ul class="dropdown-menu pull-left">
                                ...
                                <li>
                                    <a href="index.php">
                                        <i  aria-hidden="true"></i>Add Doctors</a>
                                </li>
                                 <li>
                                     <a href="<?php echo base_url();?>admin/requestDoctor">
                                        <i  aria-hidden="true"></i>Request  Doctors</a>
                                </li>
                                 <li>
                                     <a href="<?php echo base_url();?>admin/doctorList">
                                        <i  aria-hidden="true"></i>All  Doctors</a>
                                </li>
                               
                            </ul>
                         </li>    
                         <li class="classic-menu-dropdown mega-menu-dropdown">
                                <a href="#" class=" megamenu-dropdown" data-close-others="true"> <i class="fa fa-wheelchair"></i>  Patients
                                <i class="fa fa-angle-down"></i>
                                <span class="arrow "></span>
                            </a>
                            <ul class="dropdown-menu pull-left">
                                ...
                                <li>
                                    <a href="index.php">
                                        <i  aria-hidden="true"></i>Add Patients</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>admin/requestPatient">
                                        <i  aria-hidden="true"></i>Request Patients</a>
                                </li>
                                 <li>
                                    <a href="<?php echo base_url();?>admin/patientList">
                                        <i  aria-hidden="true"></i>All  Patients</a>
                                </li>
                          ...
                          <li class="classic-menu-dropdown mega-menu-dropdown">
                                ...
                                <a href="<?php echo base_url();?>admin/allComplaint" class=" megamenu-dropdown" data-close-others="true"> <i class="fa fa-comments"></i>  All Complaints 
...
<!-- Mirrored from radixtouch.in/templates/admin/redstar/source/full/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 17:56:40 GMT -->
</html><!DOCTYPE html>
