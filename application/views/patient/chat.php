                        ...
                        <!-- end message dropdown -->
 						...
 						<li class="dropdown dropdown-user">
                            ...
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username username-hide-on-mobile"><?php echo $info->name; $patientPhoto=$info->photo;?> </span>
				...
				<div class="hor-menu hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                        <li class="mega-menu-dropdown active open">
                            <a href="<?php echo base_url()?>patient" class="dropdown-toggle"> <i class="material-icons">dashboard</i>  Dashboard
                             
                            </a>
                           
                        </li>
                         <li class="classic-menu-dropdown mega-menu-dropdown">
                             <a href="<?php echo base_url()?>patient/complaint" class=" megamenu-dropdown" data-close-others="true"> <i class="fa fa-user-md"></i>  Complaint
                               
                            </a>
                      
                         </li>    
                            <li class="classic-menu-dropdown mega-menu-dropdown">          
                                <form class="search-form-opened" action="<?php echo base_url();?>patient/search" method="post">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Search..." name="search">
                                    <span class="input-group-btn">
                                         
                                     
                                        <button style=" margin-top: 4px; margin-right: 11px;">
                                            <i class="icon-magnifier"></i>
                                        </button>
                                    </span>
                                </div>
					...
					<div class="card-body contacts_body">
						...
						<li class="active">
							...
							<div class="d-flex bd-highlight">
								<div class="img_cont">
                                                                    <a href="<?php echo base_url()?>patient/chat/<?php echo $doc->doctor_id;?>">
                                                                    <img src="<?php echo $doc->photo?>" class="rounded-circle user_img"></a>
									<span class="online_icon"></span>
								</div>
								<div class="user_info">
                                                                    <a href="<?php echo base_url()?>patient/chat/<?php echo $doc->doctor_id;?>">
									<span><?php echo $doc->firstName;?> <?php echo $doc->lastName;?></span></a>
									<p><?php echo $doc->firstName;?> is online</p>
								</div>
							</div>
                                                    <?php } }?>
						</li>
					...
					<div class="card"> 
							...
							<div class="d-flex bd-highlight">
								...
								<div class="user_info">
									<span><?php
                                                                         $photo = $doc->photo;
                                                                         $degree=$doc->degree;
                                                                        echo $doc->firstName?> <?php echo $doc->lastName?></span>
						...
						<div class="card-body msg_card_body">
                                                       <?php foreach ($message as $mess){
                                                           if($mess->senderID==$patientID&&$mess->recieverID==$doctorID || $mess->senderID==$doctorID&&$mess->recieverID==$patientID ){
                                                            ?>
                                                     <?php if($mess->senderID==$doctorID){?>
							<div class="d-flex justify-content-start mb-4">
								<div class="img_cont_msg">
									<img src="<?php echo $photo;?>" class="rounded-circle user_img_msg">
								</div>
							...
							<div class="d-flex justify-content-end mb-4">
								...
								<div class="img_cont_msg">
                                                                    <img src="<?php echo $patientPhoto;?>" class="rounded-circle user_img_msg">
								</div>
							</div>
                                                      <?php } ?>
                                                           <?php } }?>
                                            ...
                                            <form action="<?php echo base_url()?>patient/saveMessage" method="post">
						<div class="card-footer">
							...
							<div class="input-group">
								...
								<textarea name="message" class="form-control type_msg" placeholder="Type your message..."></textarea>
                                                                <input type="hidden" name="senderID" value="<?php echo $patientID?>">
                                                                <input type="hidden" name="recieverID" value="<?php echo $doctorID?>">
								<div class="input-group-append">
